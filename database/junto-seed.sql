...
INSERT INTO users (
    ...
    ('Bruno Silva', 'bruno', 'bruno@example.org', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'Reader & gamer. Tech enthusiast 💻', 'bruno.jpg', FALSE, TRUE, 4, 5, 3),
...
INSERT INTO standard_post (postId, text, imageUrl) VALUES 
    ...
    (7, 'Had the best cappuccino today at that new café downtown ☕', 'posts/coffee.jpg'),
    (8, 'Does anyone else feel like Monday mornings should be illegal?', NULL),
    (9, 'Sunset from my balcony today was absolutely stunning 🌅', 'posts/sunset.jpg'),
    (10, 'Finally cleaned my entire apartment. Feeling so accomplished!', NULL),
    (11, 'Legs day at the gym = can''t walk properly tomorrow 😅', 'posts/gym.jpg'),
    (12, 'Working on a new painting. Abstract art is harder than it looks!', 'posts/painting.jpg'),
    ...
    (15, 'Best pizza I''ve ever had! Why did no one tell me about this place? 🍕', 'posts/pizza.jpg'),
    (16, 'Just booked tickets for my next trip! Can''t wait to explore new places ✈️', NULL),
    (17, 'Found my old vinyl collection in the attic. Time for a nostalgia trip!', 'posts/vinyls.jpg'),
    (18, 'My cat just knocked over my coffee. Third time this week. Send help.', 'posts/cat-mess.jpg'),
    ...
    (22, 'Nothing beats a rainy Sunday with a good book and hot chocolate.', 'posts/rainy-day.jpg'),
    (23, 'Why do all my houseplants keep dying? I give them love and water!', NULL),
    (24, 'Meal prep Sunday! Ready for a healthy week ahead 🥗', 'posts/meal-prep.jpg'),
    (25, 'That moment when you realize you''ve been singing the wrong lyrics for years...', NULL),
    (26, 'Beach day with friends = best therapy ever 🏖️', 'posts/beach.jpg'),
    (27, 'Learning Spanish on Duolingo. That owl is very threatening.', NULL),
    (28, 'Homemade bread attempt #3. Finally looks edible!', 'posts/bread.jpg'),
    ...
    (32, 'Finally organized my bookshelf by color. Yes, I''m that person now.', 'posts/bookshelf.jpg'),
    (33, 'Coding playlist recommendations? Need something to keep me focused!', NULL),
    (34, 'Adopted a rescue dog today! Meet Charlie 🐕', 'posts/dog.jpg'),
    (35, 'Why does time go so slowly at work but fly by on weekends?', NULL),
    (36, 'Homemade pasta from scratch. I''m basically a chef now 👨‍🍳', 'posts/pasta.jpg'),
    (37, 'Sometimes you just need to disconnect and enjoy the little things.', NULL),
    (38, 'New camera arrived! Time to take way too many photos of everything.', 'posts/camera.jpg'),
