    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterUsers() {
            ...
            userRows.forEach(row => {
                ...
                if (usernameElement && !usernameElement.dataset.original) {
                    usernameElement.dataset.original = usernameElement.textContent;
                }
                if (emailElement && !emailElement.dataset.original) {
                    emailElement.dataset.original = emailElement.textContent;
                }

                const name = nameElement ? nameElement.dataset.original.toLowerCase() : '';
                const username = usernameElement ? usernameElement.dataset.original.toLowerCase() : '';
                const email = emailElement ? emailElement.dataset.original.toLowerCase() : '';
