            ...
            @auth
                <ul class="space-y-2">
                    <li><a href="{{ route('search.users') }}"
                            class="block py-2 px-4 rounded hover:bg-[#7455ad] hover:text-white">Search</a></li>
                    <li><a href="#" class="block py-2 px-4 rounded hover:bg-[#7455ad] hover:text-white">Friends
                            Feed</a></li>
                    <li><a href="{{ route('friends.index') }}"
                            class="block py-2 px-4 rounded hover:bg-[#7455ad] hover:text-white">My Friends</a></li>
                    <li><a href="{{ route('friend-requests.index') }}"
                            class="block py-2 px-4 rounded hover:bg-[#7455ad] hover:text-white">Friend Requests</a></li>
                    <li><a href="{{ route('movies') }}"
                            class="block py-2 px-4 rounded hover:bg-[#7455ad] hover:text-white">Movies</a></li>
        ...
        @hasSection('title')
            <header class="bg-white shadow-sm p-4 sticky top-0 z-10 mb-0 flex justify-between items-center">
                ...
                @guest
                    <div class="flex gap-2">
                        <a href="{{ route('login') }}"
                            class="bg-[#38157a] text-white px-4 py-2 rounded-lg hover:bg-[#7455ad] hover:text-white">Login</a>
                        <a href="{{ route('register') }}"
                            class="bg-white text-[#38157a] px-4 py-2 border-[#38157a] border rounded-lg">Register</a>
                    </div>
                @endguest
            </header>
        @endif
