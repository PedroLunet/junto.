            ...
            <div class="px-10 pt-10 pb-4">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-col gap-6 items-center">
                        <x-ui.button type="submit" variant="primary">Register</x-button>
                        <a href="{{ route('google-auth') }}" class="flex items-center justify-center gap-3 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 font-normal rounded-full px-6 py-3 transition-all shadow-sm hover:shadow-md">
