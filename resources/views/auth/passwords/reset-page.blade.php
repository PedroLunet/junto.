    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                ...
                <input id="email" type="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline cursor-not-allowed @error('email') border-red-500 @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" readonly>
