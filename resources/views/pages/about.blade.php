    ...
    <div class="flex flex-col w-full">
        ...
        <div class="w-full py-8 md:py-10 lg:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                <h2 class="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 md:mb-4">About junto.
                </h2>
        ...
        <div class="w-full">
            <div
                ...
                <!-- Mission Section -->
                <section>
                    <h3 class="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Our Mission
                    </h3>
                ...
                <!-- Features Section -->
                <section>
                    <h3 class="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6">What We
                        Offer</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
                        <div class="bg-gray-50 p-5 sm:p-5 md:p-6 rounded-2xl shadow-lg">
                            ...
                            <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Movies</h4>
                        ...
                        <div class="bg-gray-50 p-5 sm:p-5 md:p-6 rounded-2xl shadow-lg">
                            <div class="text-3xl sm:text-4xl mb-3">🎵</div>
                            <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Music</h4>
                            <p class="text-sm sm:text-base text-gray-700">
                        ...
                        <div class="bg-gray-50 p-5 sm:p-5 md:p-6 rounded-2xl shadow-lg">
                            <div class="text-3xl sm:text-4xl mb-3">📚</div>
                            <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Books</h4>
                            <p class="text-sm sm:text-base text-gray-700">
                ...
                <!-- Community Section -->
                <section>
                    <h3 class="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Our
                        Community</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        <div class="border-l-4 border-[#F75C03] pl-3 md:pl-4">
                            <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Connect</h4>
                            <p class="text-sm sm:text-base text-gray-700">
                        ...
                        <div class="border-l-4 border-[#820263] pl-3 md:pl-4">
                            <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Discover</h4>
                            <p class="text-sm sm:text-base text-gray-700">
                ...
                <section
                    ...
                    <h3 class="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">Ready to Join?</h3>
