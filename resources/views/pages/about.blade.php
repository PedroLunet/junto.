    ...
    <div class="flex flex-col w-full">
        ...
        <div class="w-full bg-gray-50 py-12 md:py-16 lg:py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-4 md:mb-6">About junto.
                </h1>
        ...
        <div class="w-full bg-white">
            <div
                class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20 space-y-12 md:space-y-16 lg:space-y-20">
                <!-- Mission Section -->
                <section>
                    <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6">Our Mission
                    </h2>
                ...
                <!-- Features Section -->
                <section>
                    <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 mb-6 md:mb-8">What We
                        Offer</h2>
                ...
                <!-- Community Section -->
                <section>
                    <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6">Our
                        Community</h2>
                ...
                <!-- Call to Action -->
                <section
                    class="py-8 md:py-12 px-4 md:px-8 lg:px-12 bg-gradient-to-r from-[#F75C03] via-[#820263] to-[#291720] rounded-2xl text-white text-center">
                    ...
                    @auth
                        <x-ui.button href="{{ route('friends-feed') }}" variant="special"
                            class="text-lg md:text-xl lg:text-2xl font-medium">
                            Go to Feed
                        </x-ui.button>
                    @else
