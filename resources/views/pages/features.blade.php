...
@section('content')
    <div class="container mx-auto h-[calc(100vh-8rem)] flex items-center justify-center">
        <div class="grid grid-cols-1 md:grid-cols-4 grid-rows-3 gap-6 bento-grid">
            ...
            <!-- Box 2: Top right -->
            <div
                class="bg-[#fcdfe9] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105">
                <h1 class="text-xl font-extrabold mb-6 text-gray-900">Show Off Your Top 3 Favorites</h1>
                <p class="text-base font-normal text-gray-700">
            ...
            <!-- Box 3: Middle right -->
            <div
                class="bg-[#fef7db] rounded-3xl p-8 flex flex-col items-start justify-start shadow transition-transform duration-300 ease-in-out hover:scale-105 relative overflow-hidden">
                <h1 class="text-lg font-extrabold mb-2 text-gray-900">Find Exactly What Matters</h1>
                <p class="text-small font-normal text-gray-700 mb-14">
            ...
            <div
                class="bg-[#eff7e4] rounded-3xl p-8 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105">
                <h1 class="text-xl font-extrabold mb-6 text-gray-900">A Trusted Space</h1>
                <p class="text-base font-normal text-gray-700">
            ...
            <!-- Box 5: Bottom left -->
            <div
                class="bg-[#fde9dd] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105">
                <h1 class="text-xl font-extrabold mb-6 text-gray-900">Connect & Collaborate</h1>
                <p class="text-base font-normal text-gray-700">
            ...
            <!-- Box 6: Bottom right -->
            <div
                class="bg-[#eef2f5] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105">
                <h1 class="text-xl font-extrabold mb-6 text-gray-900">Your Feed, Your Way</h1>
                <p class="text-base font-normal text-gray-700">
