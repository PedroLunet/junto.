...
@section('content')
    <div class="container mx-auto h-[calc(100vh-8rem)] flex items-center justify-center">
        <div class="grid grid-cols-1 md:grid-cols-4 grid-rows-3 gap-6 bento-grid">
            ...
            <!-- Box 2: Top right -->
            <div
                class="bg-[#fcdfe9] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-end shadow transition-transform duration-300 ease-in-out hover:scale-105 relative overflow-hidden">
            ...
            <div
                class="bg-[#eff7e4] rounded-3xl p-8 flex flex-col items-start justify-end shadow transition-transform duration-300 ease-in-out hover:scale-105 relative overflow-hidden">
            ...
            <!-- Box 5: Bottom left -->
            <div
                class="bg-[#fde9dd] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105 relative overflow-hidden">
                ...
                <div class="absolute top-1/2 -translate-y-1/2 right-4 w-40 h-40">
            ...
            <!-- Box 6: Bottom right -->
            <div
                class="bg-[#eef2f5] rounded-3xl p-8 col-span-2 flex flex-col items-start justify-center shadow transition-transform duration-300 ease-in-out hover:scale-105 relative overflow-hidden">
