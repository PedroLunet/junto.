...
@section('content')
    ...
    <div id="adminDeleteUserModal"
        ...
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            ...
            <input type="password" id="adminDeleteUserPassword" placeholder="Enter your password"
                class="w-full px-4 py-2 border border-gray-300 rounded mb-4">
            <div class="flex gap-4">
                <button type="button" onclick="closeAdminDeleteUserModal()"
